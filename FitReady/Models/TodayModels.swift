...
/// The two-line dynamic message shown in the Today hero card.
/// Generated by `TodayViewModel.makeHeroMessage(...)` — deterministic, no AI.
struct HeroMessage {
    let headline:      String   // primary copy, may contain "\n"
    let supportingLine: String  // secondary signal: nutrition / movement / reason fallback
}
